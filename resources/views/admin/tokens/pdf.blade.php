    ...
    <div class="card-container">
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <p><strong>Catatan:</strong> ID-Trainer ini bersifat rahasia. Anda akan diminta membuat PIN 6 digit pada login pertama. Untuk reset PIN, hubungi administrator.</p>
            </div>
        </div>
        @endforeach
    </div>
